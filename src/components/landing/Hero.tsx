...
function Hero() {
    return (
        <section className="relative min-h-[85vh] flex items-center overflow-hidden pt-16">
            ...
            {/* GRADIENT ORBS */}
            <div className="absolute top-20 left-1/4 w-60 h-60 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full blur-3xl" />
            <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-gradient-to-r from-primary/15 to-primary/5 rounded-full blur-3xl" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="relative lg:pl-8 flex justify-center">
                            <div className="absolute -top-4 -left-4 w-20 h-20 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl rotate-45 blur-xl"></div>
                            <div className="absolute -bottom-6 -right-6 w-28 h-28 bg-gradient-to-br from-primary/15 to-primary/5 rounded-full blur-2xl"></div>
